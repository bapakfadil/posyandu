                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('timbang.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="tanggal_timbang" id="tanggal_timbang" class="form-input w-full" required>
                        </div>
                        <div class="mb-4">
                            <label for="tinggi_badan" class="block text-gray-700">Tinggi Badan:</label>
                            <input type="number" name="tinggi_badan" id="tinggi_badan" class="form-input w-full" required>
                        </div>
                        <div class="mb-4">
                            <label for="berat_badan" class="block text-gray-700">Berat Badan:</label>
                            <input type="number" name="berat_badan" id="berat_badan" class="form-input w-full" required>
                        </div>
                        <div class="mb-4">
                            <label for="keterangan" class="block text-gray-700">Keterangan:</label>
                            <textarea name="keterangan" id="keterangan" class="form-input w-full"></textarea>
                        </div>
                        <div class="mb-4">
